...
function Portfolio() {
    var app1 = require("../img/ureats.png")
  return (
  <div>
      <Navbar />
    ...
    <div className="container">
        <div className="row">
                <div className="col col-sm-3" id="BSEat">
                    <div className="card" style={{width: "18rem"}} >
                        <img className="card-img-top" src="../img/BSeatHome.png" alt="Boston Students Eat"/>
                ...
                <div className="col col-sm-3" id="Weather">
                    <div className="card" style={{width: "18rem"}}>
                        <img className="card-img-top" src="../img/WeatherParis.png" alt="Weather Dashboard"/>
                        <div className="card-body">
                ...
                <div className="col col-sm-3" id="teamProfID">
                    <div className="card" style={{width: "18rem"}}>
                        <img className="card-img-top" src="../img/livehtml.png" alt="Team Profile Builder" id="teamimg"/>
                        <div className="card-body">
        ...
        <div className="row">
                <div className="col col-sm-3" id="expressNote">
                    <div className="card" style={{width: "18rem"}}>
                        <img className="card-img-top" src="../img/noteTaker.png" alt="Express Note Taker" id="noteImg"/>
                        <div className="card-body">
                ...
                <div className="col col-sm-3" id="yourEatsID">
                    <div className="card" style={{width: "18rem"}} >
                        <img className="card-img-top" src="../img/ureats.png" alt="yourEats"/>
                        <div className="card-body">
