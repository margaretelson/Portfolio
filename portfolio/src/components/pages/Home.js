    ...
    <div>
        <main className="container-fluid">
            ...
            <div className="media">
                ...
                <div className="row">
                    <button id="linkedin" type="button"><a href="https://www.linkedin.com/in/margaret-elson-b59627161/" className="btn btn-outline-info" ><i className="fa fa-linkedin"><br>Linkedin</i></a>
                    <br />
                    <button id="instagram" type="button"><a href="https://www.instagram.com/margaretelson/" className="btn btn-outline-danger" ><i className="fa fa-instagram"><br>Instagram</i></a>
                    <br />
                    <button id="facebook" type="button"><a href="https://www.facebook.com/margaret.elson.3/" className="btn btn-outline-primary"><i className="fa fa-facebook-square"><br>Facebook</i></a>
                    <br />
                    <button id="github" type="button"><a href="https://github.com/margaretelson" className="btn btn-outline-secondary"><i className="fa fa-github-square"><br>Github</i></a>
                    <br />
                    <button id="phone" type="button"><a href="tel:5132646274" className="btn btn-outline-warning"><i class="fa fa-phone"><br>(513)264-6274</i></a>
                    <br />
                    <button id="email" type="button"><a href="mailto:margaret.a.elson@gmail.com" className="btn btn-outline-success"><i className="fa fa-envelope"><br>Email</i></i></a>
                </div>
                </div>
            </div>
            </section> 
